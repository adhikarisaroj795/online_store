              ...
              <div class="container text-center">
                <div class="row">
                  <div class="col-sm-6 image">
                    <div class="item">
                      <h1>Today Deal</h1>
                      <img class="img-fluid" src="https://martinvalen.com/20379-large_default/men-s-ripped-printted-baggy-jeans-in-blue.jpg" alt="">
                    </div><!--enditem-->
                  </div><!--endcol-->
                  <div class="col-sm-6">
                    ...
                    <div class="details">
                      <h2 class="cr3"> Ripped printted baggy jeans</h2>
                      <p class="cr4"> MEN'S RIPPED PRINTTED BAGGY JEANS IN BLUE <br> IS A PART OF THE MARTIN VALEN JEANS COLLECTION.</p>
                      <div class="rating">
          ...
          <div class="container text-center">
            <div class="row">
              <div class="col-sm-6 image">
                <div class="item">
                  <h1>Today Deal</h1>
                  <img class="img-fluid" src="https://st2.depositphotos.com/1000128/6284/i/950/depositphotos_62849427-stock-photo-smart-tv.jpg" alt="">
                </div><!--enditem-->
              </div><!--endcol-->
              <div class="col-sm-6">
                <div class="top d-flex justify-content-center">
                ...
                <div class="details">
                  <h2 class="cr3">Samsung Smart TV</h2>
                  <p class="cr4">More for you<br>With smart TV.</p>
                  <div class="rating">
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
          ...
          <div class="container text-center">
            <div class="row">
              <div class="col-sm-6 image">
                <div class="item">
                  <h1></h1>
                <img class="img-fluid" src="https://www.notebookcheck.net/fileadmin/_processed_/9/a/csm_4_zu_3_realme_GT_Neo_2_3ca752f2cd.jpg" alt="">
                       </div><!--enditem-->
                     </div><!--endcol-->
              <div class="col-sm-6">
                <div class="top d-flex justify-content-center">
                ...
                <div class="details">
                  <h2 class="cr3">Realme GT Neo2</h2>
                  <p class="cr4">Everything in Neo.</p>
                  <div class="rating">
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
