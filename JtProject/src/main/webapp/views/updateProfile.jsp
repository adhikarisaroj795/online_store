    ...
    <div class="col-sm-6">
        ...
        <form action="updateuser" method="post">
            ...
            <div class="form-group">
                ...
                <input type="email" required class="form-control form-control-lg" required placeholder="Email*" value="${email}" required name="email" id="email"
            ...
            <div class="form-group">
                ...
                <textarea class="form-control form-control-lg" rows="3" placeholder="Enter Your Address" name="address"> value="${address}"</textarea>
            </div>
